...
import { reactivateAnimalController } from './reactivate-animal/reactivate-animal.controller'
...
export async function animalRoutes(app: FastifyInstance) {
  ...
  app.post('/animal.reactivate/:id', authorize('AdminPanel', 'Animals'), reactivateAnimalController)
}
