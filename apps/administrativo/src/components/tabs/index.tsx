...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex w-full flex-wrap items-center justify-center gap-x-0.5 gap-y-4 rounded-lg bg-zinc-100 p-1 text-zinc-600 lg:w-auto',
      className,
    )}
    {...props}
  />
