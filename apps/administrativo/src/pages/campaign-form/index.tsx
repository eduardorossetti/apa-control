...
const campaignSchema = z
  .object({
    ...
    title: z.string().trim().min(1, RequiredMessage).max(200),
    description: z.string().trim().min(1, RequiredMessage),
    startDate: z.string({ error: RequiredMessage }).trim().min(1, RequiredMessage),
    endDate: z.string({ error: RequiredMessage }).trim().min(1, RequiredMessage),
